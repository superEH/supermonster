...
if ($help || !$ip) {
  print <<'EOL';
 _ __ ___   ___  _ __  ___| |_ ___ _ __    __| | __| | ___  ___ 
| '_ ` _ \ / _ \| '_ \/ __| __/ _ \ '__|  / _` |/ _` |/ _ \/ __|
| | | | | | (_) | | | \__ \ ||  __/ |    | (_| | (_| | (_) \__ \
|_| |_| |_|\___/|_| |_|___/\__\___|_|     \__,_|\__,_|\___/|___/

 udp.pl Criado por SEH
...
print "Queimado o Modem Em 3,2,1: $ip " . ($port ? $port : "By:") . " Monster_Official " . 
  ($size ? "$size-byte" : "UDP By: Monster") . " www.youtube.com/user/MonsterOfficial" . ($time ? " for $time seconds" : "") . "\n";
